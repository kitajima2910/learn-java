...
public class Lab05 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < student.length; i++) {
            ...
            System.out.println("Enter your toan, ly, hoa, sinh, van: ");
            student[i].setToan(Float.parseFloat(scanner.nextLine()));
            student[i].setLy(Float.parseFloat(scanner.nextLine()));
            student[i].setHoa(Float.parseFloat(scanner.nextLine()));
            student[i].setSinh(Float.parseFloat(scanner.nextLine()));
            student[i].setVan(Float.parseFloat(scanner.nextLine()));
        }
        ...
        for (Student sv : student) {
            ...
            System.out.println("Rank: " + sv.tinhDiemTrungBinh());
        }
    }
